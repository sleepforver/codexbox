...
- 电力地理：GeoJSON 体检、字段模板、几何类型统计、坐标范围、必填属性检查和项目历史。
...
二期从项目维度的能力建设开始。当前已新增项目工作区，用于登记常用本地项目目录、业务标签和说明；AI 历史、API 请求集合、Git 默认目录和电力地理体检历史已支持项目关联，项目工作区可导入导出项目列表和项目数据包。
